...
# --- Config ---
DEFAULT_START_DAYS_AGO=90
DEFAULT_END_DAYS_AGO=0
MIN_COMMITS_PER_DAY=1
MAX_COMMITS_PER_DAY=8
# Probability (out of 100) that any given day gets commits.
# Lower = more random gaps. 50 means ~half the days get skipped.
COMMIT_PROBABILITY=45
...
read -rp "Start date? [default: $(date -d "-${DEFAULT_START_DAYS_AGO} days" -I)] : " input_start
